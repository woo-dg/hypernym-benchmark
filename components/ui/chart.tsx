...
export function ChartContainer({ title, children, className, ...props }: ChartContainerProps) {
  return (
...
export function ChartTooltipContent({ content, className, children, ...props }: ChartTooltipContentProps) {
  return (
